...
namespace MockIAPLib
{
    public class CurrentApp
    {
        ...
        {
            return AsyncInfo.Run<ListingInformation>(_ => LoadListingInformationAsync_());
        }

        public static async Task<ListingInformation> LoadListingInformationAsync_()
        {
            MockIAP.CheckIfInitialized();
        ...
        {
            return AsyncInfo.Run<string>(_ => RequestProductPurchaseAsync_(ProductId, includeReceipt));
        }

        public static async Task<string> RequestProductPurchaseAsync_(string ProductId, bool includeReceipt)
        {
            MockIAP.CheckIfInitialized();
